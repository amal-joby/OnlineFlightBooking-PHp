...
if(isset($_SESSION['adminId'])) {
    if(isset($_POST['dep_but'])) {
        ...
        $sql = "UPDATE `flight` SET `status`='dep' WHERE `flight_id`='$flight_id';";
        ...
        */
        if($row = mysqli_fetch_assoc($result)) {
            ...
            $sql = "UPDATE `flight` SET `status`='issue',`issue`='$issue',`departure`='$stamp_dep',`arrivale`='$stamp_arr' WHERE `flight_id`='$flight_id';";
            /*
            $stmt = mysqli_stmt_init($conn);
            mysqli_stmt_prepare($stmt,$sql);
      ...
      $flight_id = $_POST['flight_id'];
      $sql = "UPDATE `flight` SET `status`='',`issue`='solved' WHERE `flight_id`='$flight_id';";
      /*
      $stmt = mysqli_stmt_init($conn);
      mysqli_stmt_prepare($stmt,$sql);
      mysqli_stmt_bind_param($stmt,'i',$flight_id);         
      ...
      */
      ...
      $flight_id = $_POST['flight_id'];
      $issue = $_POST['issue'];
      $sql = "UPDATE `flight` SET `status`='arr' WHERE `flight_id`='$flight_id';";
      $sqlResult = mysqli_query($conn,$sql);
      /*
      $stmt = mysqli_stmt_init($conn);
      mysqli_stmt_prepare($stmt,$sql);
