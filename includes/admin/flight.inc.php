...
if(isset($_POST['flight_but']) and isset($_SESSION['adminId'])) {
    ...
    if($flag == false) {
      ...
      $sql = "SELECT * FROM `airline` WHERE `airline_id` ='$air_id';";
      /*
      ...
      */
      ...
      if($row = mysqli_fetch_assoc($result)) {
        ...
        $sql = "INSERT INTO `flight`(`admin_id`,`arrivale`,`departure`,`destination`,`source`,
          `airline`,`seats`,`duration`,`price`,`status`,`issue`) VALUES ('$admin_id','$arrival','$departure','$arr_city','$dep_city','$airline_name','$seats','$dura','$price','','');";
        /*$sql = "INSERT INTO `flight`(`admin_id`,`arrivale`,`departure`,`destination`,`source`,
          `airline`,`seats`,`duration`,`price`,`status`,`issue`) VALUES ('$admin_id','$arrival','$departure','$arr_city','$dep_city','$airline_name','$seats','$dura','$price','','')";
          */
