...
<main>
    ...
    $sql_t = "SELECT * FROM `ticket` WHERE `user_id`='$sessionUserid';";
    //$stmt_t = mysqli_stmt_init($conn);
    ...
    if(!$result_t){
        ...
        */
        ...
        /*  
            ...
            $stmt = mysqli_stmt_init($conn);
            */
            $passengerId = $row_t['passenger_id'];
            $flightId = $row_t['flight_id'];
            $sql = "SELECT * FROM `passenger_profile` WHERE `passenger_id`='$passengerId';";
            ...
            if(!$sqlResult){
                ...
                */
                ...
                if ($row = mysqli_fetch_assoc($sqlResult)) {
                    $sql_f = "SELECT * FROM `flight` WHERE `flight_id`='$flightId'; ";
