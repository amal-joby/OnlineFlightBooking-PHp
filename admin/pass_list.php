          ...
          <div class="container-md mt-2">
            ...
            <table class="table table-bordered">
              ...
              <tbody>
                ...
                $sql_t = "SELECT * FROM `ticket` WHERE `flight_id`='$flight_id';";
                //$stmt_t = mysqli_stmt_init($conn);
                  ...
                  /*
                    ...
                    */
                    while($row_t = mysqli_fetch_assoc($result_t)) {
                      $passenger_id = $row_t['passenger_id'];                 
                      $sql = "SELECT * FROM `passenger_profile` WHERE `passenger_id`='$passenger_id';"; 
                      /* 
                      ...
                      */
                      ...
                      if ($row = mysqli_fetch_assoc($result)) {
                        $user_id = $row['user_id'];
                          $sql_p = "SELECT * FROM `payment` WHERE `flight_id`='$flight_id' AND `user_id`='$user_id';";
