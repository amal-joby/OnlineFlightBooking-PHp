        ...
        if(!$result){
            ...
            */
            ...
            $ticket_id = $row['ticket_id'];
              $sql_pas = "DELETE FROM `passenger_profile` WHERE `passenger_id`='$passenger_id'; ";
              $result_pas = mysqli_query($conn,$sql_pas);
              /*
        ...
        /*
          ...
          */
          while ($row = mysqli_fetch_assoc($result)) {
            ...
            $sql_p = "SELECT * FROM `passenger_profile` WHERE `passenger_id`='$passenger_id';";
            ...
            if(!$result_p){
                ...
                */
                if($row_p = mysqli_fetch_assoc($result_p)) {
                  $sql_f = "SELECT * FROM `flight` WHERE `flight_id`='$flight_id';";
